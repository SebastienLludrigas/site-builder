...
export default function Editor({ siteId, onBackToDashboard }) {
  ...
  return (
    <div className="h-screen bg-slate-950 text-slate-100 flex flex-col overflow-hidden">
      ...
      {/* 1. TOP APP BAR */}
      <header className="h-14 bg-slate-900 border-b border-slate-800 px-4 flex items-center justify-between z-30 flex-shrink-0">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            <input
              ...
              className="bg-transparent text-sm font-bold text-white hover:bg-slate-800/60 px-2 py-1 rounded-lg border border-transparent hover:border-slate-700 outline-none focus:border-indigo-500 max-w-[200px] sm:max-w-xs transition"
            />
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            onClick={handleSave}
            disabled={isSaving}
            className={`flex items-center gap-1.5 px-4 py-1.5 text-xs font-semibold rounded-lg shadow-md transition ${
              hasUnsavedChanges
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        {!isPreviewMode && (
          <aside className="w-80 bg-slate-900 border-r border-slate-800 flex flex-col flex-shrink-0 z-20">
            ...
            {activeSidebarTab === 'sections' && (
              <div className="flex-1 overflow-y-auto p-4 flex flex-col justify-between">
                ...
                <div className="pt-4 mt-4 border-t border-slate-800">
                  <button
                    type="button"
                    onClick={() => { setInsertAtIndex(null); setIsAddSectionOpen(true); }}
